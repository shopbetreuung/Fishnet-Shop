...
INSERT INTO content_manager VALUES (29, 0, 0, '', 3, 'Index', 'Bienvenue', '<p>{$greeting}<br /><br />Ceci est l\'installation standard du projet osCommerce Forking - xt:Commerce. Tous les produits ici exposés servent à la démonstration du mode d\'emploi. Ainsi, si vous commander des produits, ceux-ci ne seront ni livrés, ni facturés. Toutes informations sur les produits sont fictifs , le client n\'a donc aucun droit de revendication.<br /><br />Si vous souhaitez appliquer ce programme sur lequel le shop est basé, veuillez visister la page support de notre site xt:Commerce. Ce shop est basé sur la version v3.0.4 de  xt:Commerce Version v3.0.4<br /><br />Le texte affiché ici peut être modifier  sur AdminInterface dans  <b>Content Manager</b> - Entrée Index.</p>', 0, 1, '', 0, 5, 0, '', '', '', NOW(), 1);
