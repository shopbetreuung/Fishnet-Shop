<?php
/* --------------------------------------------------------------
   $Id: imagesliders.php 899 2008-07-29 14:01:00Z Hetfield $   
...
define('TEXT_NONE_TARGET', 'Kein Ziel festlegen');
define('TEXT_BLANK', '_blank');
define('TEXT_TOP', '_top');
define('TEXT_SELF', '_self');
define('TEXT_PARENT', '_parent');
define('TEXT_IMAGESLIDERS_DESCRIPTION', 'Imagedescription:');
define('TEXT_DELETE_INTRO', 'Are you sure you want to delete the image?');
define('TEXT_DELETE_IMAGE', 'Delete imagefile too?');
define('ERROR_DIRECTORY_NOT_WRITEABLE', 'Error: Das Verzeichnis %s ist schreibgesch&uuml;tzt. Bitte korrigieren Sie die Zugriffsrechte zu diesem Verzeichnis!');
define('ERROR_DIRECTORY_DOES_NOT_EXIST', 'Error: Das Verzeichnis %s existiert nicht!');
define('TEXT_DISPLAY_NUMBER_OF_IMAGESLIDERS', 'Anzahl Bilder in Slideshow');
