...
define('MODULE_PAYMENT_PAYONE_WLT_TEXT_DESCRIPTION', 'Paiement par e-Wallet (PayPal) avec PayOne');
define('MODULE_PAYMENT_PAYONE_WLT_TEXT_INFO', 'Paiement par e-Wallet (PayPal)');
