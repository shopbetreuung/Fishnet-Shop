...
define('MODULE_PAYMENT_PAYONE_ELV_TEXT_TITLE', 'note de débit');
define('MODULE_PAYMENT_PAYONE_ELV_TEXT_DESCRIPTION', 'note de débit avec PayOne');
define('MODULE_PAYMENT_PAYONE_ELV_TEXT_INFO', 'note de débit');
