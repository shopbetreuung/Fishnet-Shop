...
class idealo{
    ...
    public function __construct() {
      ...
      $this->description = '<center><a href="http://www.idealo.de" target="_blank" rel="noopener">'.xtc_image(DIR_WS_CATALOG.'export/idealo/logo_blue_big.png').'</a></center>';
    	...
    	$html = '	<body bgcolor="#99CCFF">
						...
						<font face="Arial,MS Sans Serif">
			 			...
			 			<form action="javascript:history.back()">
			 				<br><br>
			 				<div id="logo">
								<a href="http://www.idealo.de" target="_blank" rel="noopener">'.xtc_image(DIR_WS_CATALOG.'export/idealo/logo_blue_big.png', 'Price Comparison', '', '', 'class="logo noborder"').'</a>
							</div>
