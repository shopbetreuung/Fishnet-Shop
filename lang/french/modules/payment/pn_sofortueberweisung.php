...
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_DESCRIPTION_CHECKOUT_PAYMENT_IMAGE', '
     <table border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td valign="bottom"><a href="https://www.sofortueberweisung.de/funktionsweise" target="_blank" rel="noopener">{{image}}</a></td>
      </tr>
      <tr>
...
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_STATUS_TITLE' , 'Activer DIRECTebanking.com direct module');
...
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_ZONE_TITLE' , 'Zone de paiement');
...
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_REASON_1_TITLE','Raison ligne 1');
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_REASON_1_DESC', 'In the Raison ligne 1 the following options are available');
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_REASON_2_TITLE','Raison ligne 2');
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_REASON_2_DESC', 'Dans le motif (27 caractères maximum), les caractères de remplacement suivants seront remplacés :<br /> {{order_id}}<br />{{order_date}}<br />{{customer_id}}<br />{{customer_name}}<br />{{customer_company}}<br />{{customer_email}}');
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_IMAGE_TITLE','Graphique de sélection de paiement / texte');
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_IMAGE_DESC','Représentation graphique / texte dans la sélection des options de paiement.');

define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_ERROR_HEADING', 'L&apos;erreur suivante a été annoncée par DIRECTebanking.com au cours du processus.:');
define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_ERROR_MESSAGE', 'Le paiement via DIRECTebanking.com n&apos;est malheureusement pas possible ou a été annulé par le client. Veuillez choisir un autre mode de paiement.');

define('MODULE_PAYMENT_PN_SOFORTUEBERWEISUNG_TEXT_INFO', 'Payer facilement avec le système bancaire en ligne certifié et vérifié Sofort&uuml;berweisung');
?>
