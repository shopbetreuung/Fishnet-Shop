...
$lang_array = array(
  ...
  'MODULE_PAYMENT_PAYPALPLUS_TEXT_INFO' => '<div style="padding: 15px;text-align: center;margin: 10px 0px -13px;color: #003087;">Please select one of the payment methods listed here by clicking.</div>',
