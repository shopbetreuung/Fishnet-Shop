...
define('TEXT_LINK_NAME', 'ausgangsrechnungen');
define('TEXT_INVOICE_NUMBER', 'Rechnungsnummer');
define('TEXT_INVOICE_DATE', 'Rechnungsdatum');
define('TEXT_TOTAL_NET', 'Betrag netto');
