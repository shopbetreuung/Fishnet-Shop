...
define('HEADING_TITLE_SEARCH', 'Cherchez: ');
...
define('TABLE_HEADING_STOCK','Avertissement de stock');
...
define('TABLE_HEADING_PRODUCTS_MODEL','Produits Modèle');
...
define('TEXT_NEW_PRODUCT', 'Nouveau produit en &quot;%s&quot;');
define('TEXT_CATEGORIES', 'Catégories:');
define('TEXT_PRODUCTS', 'Produits:');
define('TEXT_PRODUCTS_PRICE_INFO', 'Prix:');
define('TEXT_PRODUCTS_TAX_CLASS', 'Catégorie de taxe:');
define('TEXT_PRODUCTS_AVERAGE_RATING', 'Cote moyenne:');
define('TEXT_PRODUCTS_QUANTITY_INFO', 'Quantité:');
define('TEXT_PRODUCTS_DISCOUNT_ALLOWED_INFO', 'Max. autorisé Remise:');
...
define('TEXT_NO_CHILD_CATEGORIES_OR_PRODUCTS', 'Merci d&apos;insérer une nouvelle catégorie ou un nouveau produit dans  <br />&nbsp;<br /><b>%s</b>');
define('TEXT_PRODUCT_MORE_INFORMATION', 'Pour plus d&apos;informations, veuillez visiter le <a href="http://%s" target="_blank" rel="noopener"><u>site web</u></a> de ce produit.');
define('TEXT_PRODUCT_DATE_ADDED', 'Ce produit a été ajouté à notre catalogue le %s.');
define('TEXT_PRODUCT_DATE_AVAILABLE', 'Ce produit sera en stock à %s.');

define('TEXT_EDIT_INTRO', 'Veuillez apporter les modifications nécessaires.');
define('TEXT_EDIT_CATEGORIES_ID', 'Catégorie  ID:');
define('TEXT_EDIT_CATEGORIES_NAME', 'Catégorie Nom:');
define('TEXT_EDIT_CATEGORIES_HEADING_TITLE', 'Intitulé de catégorie:');
define('TEXT_EDIT_CATEGORIES_DESCRIPTION', 'Catégorie Description:');
define('TEXT_EDIT_CATEGORIES_IMAGE', 'Catégorie Image:');

define('TEXT_EDIT_SORT_ORDER', 'Ordre de tri:');

define('TEXT_INFO_COPY_TO_INTRO', 'Veuillez choisir une nouvelle catégorie dans laquelle vous souhaitez copier ce produit.');
...
define('TEXT_PRODUCTS_WHOLESALER_REORDER', 'Reorder at wholesaler from X units:');
...
define('CANONICAL_LINK','Lien canonique');   
