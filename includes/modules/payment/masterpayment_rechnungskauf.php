...
require_once(DIR_FS_CATALOG . 'includes/masterpayment/MasterpaymentActions.class.php');
  ...
  class masterpayment_rechnungskauf extends MasterpaymentActions {
    ...
    function install() {
	  ...
	  xtc_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_key, configuration_value, configuration_group_id, sort_order, set_function, date_added) values ('MODULE_PAYMENT_MASTERPAYMENT_RECHNUNGSKAUF_SEND_ORDERID', 'false', '6', '1', 'xtc_cfg_select_option(array(\'frue\', \'false\'), ', now());");		     
