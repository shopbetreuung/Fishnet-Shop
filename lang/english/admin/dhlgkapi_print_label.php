...
define('MODULE_SHIPPING_DHLGKAPI_EMAILTEXT','Your parcel will be shipped today with DHL.');
define('MODULE_SHIPPING_DHLGKAPI_EMAILTEXT_TOMORROW','Your parcel will be shipped on the next working day with DHL.');
define('MODULE_SHIPPING_DHLGKAPI_CANCELTEXT','The shipment with DHL has been canceled.');
