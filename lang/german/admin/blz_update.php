...
define('BLZ_INFO_TEXT', '<p>Dieses Formular aktualisiert die Bankleitzahlentabelle der Shophelfer Shopsoftware. Die BLZ-Tabelle wird bei der Bestellung zur &Uuml;berpr&uuml;fung der Bankdaten verwendet.<br/>Die Bundesbank stellt alle 3 Monate aktualisierte Dateien zur Verf&uuml;gung.</p><p><strong>Updatehinweise:</strong></p><p>Zur Aktualisierung bitte die <a href="https://www.bundesbank.de/de/aufgaben/unbarer-zahlungsverkehr/serviceangebot/bankleitzahlen/download---bankleitzahlen-602592" target="_blank" rel="noopener"><strong>BLZ-Downloadseite der Bundesbank</strong></a> in einem weiteren Browser-Tab &ouml;ffnen. Im unteren Drittel der Bundesbank-Webseite steht unter der &Uuml;berschrift "Bankleitzahlendateien ungepackt" auch ein Downloadlink f&uuml;r die aktuelle BLZ-Datei im Textformat (TXT) zur Verf&uuml;gung. Diesen Link kopieren (Mausklick mit rechter Maustaste auf den Link, dann Link-Adresse kopieren) und dann hier ins Editierfeld eintragen.</p><p>Der Button "Aktualisieren" startet den Aktualisierungsvorgang.<br/>Die Aktualisierung dauert einige Sekunden.</p><p><i>Beispiel-Link f&uuml;r den Zeitraum vom 06.03.2017 bis 04.06.2017:</i></p>');
