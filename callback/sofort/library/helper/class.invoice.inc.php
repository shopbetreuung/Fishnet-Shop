 ...
 * @version $Id: class.invoice.inc.php 3760 2012-10-10 12:33:43Z gtb-modified $
 * @package sofortLib
...
class PnagInvoice extends PnagAbstractDocument {
	...
	*/
	...
	public function getError() {
		...
		if ($this->EditSr) {
			if ($this->EditSr->isError('sr')) {
				return $this->EditSr->getErrors('sr');
			}
		}
		
		if ($this->CancelSr) {
			if ($this->CancelSr->isError('sr')) {
				return $this->CancelSr->getErrors('sr');
			}
		}
