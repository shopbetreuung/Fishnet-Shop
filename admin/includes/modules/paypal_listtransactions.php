...
<table class="table table-bordered">
				<tr class="dataTableHeadingRow">
					...
					<td class="dataTableHeadingContent hidden-xs"><?php echo TABLE_HEADING_PAYMENT_TYPE; ?></td>
					<td class="dataTableHeadingContent hidden-xs"><?php echo TABLE_HEADING_PAYMENT_STATUS; ?></td>
					<td class="dataTableHeadingContent hidden-xs"><?php echo TEXT_PAYPAL_PENDING_REASON; ?></td>
					<td class="dataTableHeadingContent hidden-xs" align="right"><?php echo TABLE_HEADING_PAYMENT_AMOUNT; ?></td>
...
?>
					<td class="dataTableContent hidden-xs" nowrap><?php echo $paypal->getStatusSymbol($ipn_data['payment_status'],$ipn_data['txn_type'],$ipn_data['pending_reason']); ?></td>
					...
					<td class="dataTableContent hidden-xs" nowrap><?php echo $ipn_data['txn_id']; ?></td>
					...
					<td class="dataTableContent hidden-xs" nowrap><?php echo $ipn_data['txn_type'] . '<br />'; ?></td>
					<td class="dataTableContent hidden-xs" nowrap><?php echo $ipn_data['payment_type']; ?></td>
					<td class="dataTableContent hidden-xs" nowrap><?php echo $paypal->getStatusName($ipn_data['payment_status'],$ipn_data['txn_type']);?></td>
					<td class="dataTableContent hidden-xs" nowrap><?php echo $ipn_data['pending_reason']; ?></td>
					<td class="dataTableContent hidden-xs" align="right" nowrap><?php
...
?>
    ...
    <div class="col-xs-6 smallText" ><?php echo $ipn_split->display_count($ipn_query_numrows, '30', $_GET['page'], TEXT_DISPLAY_NUMBER_OF_PAYPAL_TRANSACTIONS); ?></div>
    <div class="col-xs-6  smallText text-right" ><?php echo $ipn_split->display_links($ipn_query_numrows, '30', MAX_DISPLAY_PAGE_LINKS, $_GET['page']); ?></div>
