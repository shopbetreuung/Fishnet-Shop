...
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_TITLE', 'transfert en ligne');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_DESCRIPTION', 'transfert en ligne avec PayOne');
define('MODULE_PAYMENT_PAYONE_OTRANS_TEXT_INFO', 'transfert en ligne');
