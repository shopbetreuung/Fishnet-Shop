...
class payone_cod extends PayonePayment {
	...
	function selection() {
		if ($this->pg_config['types']['cod']['active'] == 'true') {
    ...
    if (!isset($insert_id) || $insert_id == '') {
		...
		$this->payment_method = new Payone_Api_Request_Parameter_Authorization_PaymentMethod_CashOnDelivery();
		$this->payment_method->setShippingprovider('DHL'); // hardcoded for now
		
    $request_parameters = parent::_request_parameters('cod');
    ...
    parent::_build_service_authentification('cod');
