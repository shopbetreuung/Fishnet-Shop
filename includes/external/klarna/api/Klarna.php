...
class Klarna
{
     ...
     * @var string
     */
    protected $VERSION = 'php:modified:1.0.0';
     ...
     * @var bool
     */
    public static $x_forwarded_for = true;
...
if($billing['telno'] == $billing['cellno'])$billing['cellno'] = '';
if($shipping['telno'] == $shipping['cellno'])$shipping['cellno'] = '';
		...
		// fixing problem with the vat values - they were 18.999999... but not exactly 19
        foreach($paramList['18'] as $tmp_key => $tmp_value){
			$paramList['18'][$tmp_key]['goods']['vat'] = round($paramList['18'][$tmp_key]['goods']['vat']);
		}
