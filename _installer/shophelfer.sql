...
INSERT INTO content_manager VALUES (29, 0, 0, '', 3, 'Index', 'Bienvenue', '<p>{$greeting}<br /><br />Ceci est une installation de base du système de boutique en ligne fishnet-shop.com. Cette page, les catégories, les produits, les services et les offres sont uniquement destinés à démontrer la fonctionnalité de ce système de boutique. Si vous commandez des produits, ils ne seront ni livrés ni facturés.<br /><br />Le système de boutique fishnet-shop.com est entièrement gratuit et open source. Toutes les informations sur le projet sont disponibles sur notre site internet : fishnet-shop.com<br /><br />Ce texte peut être édité dans la zone d\'administration sous  <b>Contenu</b> - Content Manager - Edit Index.<br/><br/>Fishnet Services vous souhaite beaucoup de succès avec votre nouveau système de boutique !</p>', 0, 1, '', 0, 5, 0, '', '', '', NOW(), 1);
INSERT INTO content_manager VALUES ('', 0, 0, '', 3, 'Bons d\'achat', 'Bons d\'achat – Questions et réponses', '<div class="row">\r\n	<div class="col-xs-12">\r\n		<div><strong>Acheter des bons d\'achats </strong></div>\r\n        <div>S\'ils sont proposés dans la boutique, les bons peuvent être achetés comme des produits normaux.
Dès que vous avez acheté un bon d\'achat et qu\'il a été activé après un paiement réussi, le montant apparaîtra sous votre panier. Vous pouvez maintenant envoyer le montant désiré par e-mail via le lien &quot;envoyer le bon d\'achat&quot;.</div>\r\n	</div>\r\n</div>\r\n<div class="row">\r\n	<div class="col-xs-12">\r\n		<div><strong>Comment envoyer un bon d\'achat </strong></div>\r\n		<div>Dès que vous avez un solde créditeur, vous pouvez l\'utiliser pour payer votre commande. Pendant le processus de commande, vous avez la possibilité d\'échanger votre crédit. Si le crédit est inférieur à la valeur de la marchandise, vous devez choisir votre mode de paiement préféré pour la différence. Si votre solde créditeur dépasse la valeur de la marchandise, le solde créditeur restant sera bien entendu disponible pour votre prochaine commande. </div>\r\n	</div>\r\n</div>\r\n<div class="row">\r\n	<div class="col-xs-12">\r\n		<div><strong>Acheter avec les bons d\'achat </strong></div>\r\n        <div>Dès que vous avez un solde, vous pouvez en disposer pour régler votre commande. Pendant la procédure de commande, vous avez la possibilité de comptabiliser votre solde. Si votre solde est inférieur au montant total de la commande, c''est à vous d\'indiquer le moyen de paiement souhaité pour la différence. Si votre solde excède le montant total de la commande, ce nouveau solde reste à votre entière disposition pour votre prochaine commande.</div>\r\n	</div>\r\n</div>\r\n<div class="row">\r\n	<div class="col-xs-12">\r\n		<div><strong>Réservez des bons d\'achat.</strong></div>\r\n        <div>Si vous avez reçu un bon par e-mail, vous pouvez réserver le montant comme suit :<br />1. cliquez sur le lien fourni dans le courriel. Si vous n\'avez pas encore de compte client personnel, vous avez la possibilité d\'ouvrir un compte. <br />2. Après avoir mis un produit dans le panier d\'achat, vous pouvez entrer votre code de bon de réduction.</div>\r\n	</div>\r\n</div>\r\n<div class="row">\r\n	<div class="col-xs-12">\r\n		<div><strong>Si vous rencontrez des problèmes avec un bon d\'achat, veuillez nous contacter par e-mail : you@yourdomain.com. Veuillez décrire le problème le plus précisément possible, les détails importants sont entre autres : Votre numéro de client, le code de bon d\'achat, les messages d\'erreur du système et le navigateur que vous utilisez (par ex. "Internet Explorer 6" ou "Firefox 1.5").</div>\r\n	</div>\r\n</div>', 0, 1, '', 0, 6, 1, '', '', '', NOW(), 1);
