<?php
  ...
  define('TEXT_WELCOME_INDEX','<b>Welcome to shophelfer.com Shopsoftware</b><br /><br />The shophelfer.com Shopsoftware is an open source e-commerce solution that is constantly developed by Fishnet Services<br /> Its out-of-the-box installation allows the shop owner to install, run and manage his online shop with a minimum of effort and expense.<br />The shophelfer.com Shopsoftware runs on any system that provides a PHP environment (starting with PHP 5.0) and MySQL, such as Linux, Solaris, BSD, and Microsoft Windows.<br /><br />With no restrictions or special requirements, the shophelfer.com Shopsoftware can be installed on on any environment that supports PHP 5.0 and MySQL, which includes Linux, Solaris, BSD, and Microsoft Windows environments.<br /><br />The shophelfer.com Shopsoftware is an OpenSource project - we always look forward to help.');
