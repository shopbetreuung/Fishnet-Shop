...
define('MODULE_SHIPPING_DHLGKAPI_TEXT_TITLE', 'DHL inc. Wunschpaket');
define('MODULE_SHIPPING_DHLGKAPI_TEXT_DESCRIPTION', 'DHL Versenden inkl. Empfängerservices');
...
define('MODULE_SHIPPING_DHLGKAPI_DAYNAMES', serialize(array('Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat')));
...
define('MODULE_SHIPPING_DHLGKAPI_PL_TITLE', '<u>or</u><br /><br />Preferred location');
define('MODULE_SHIPPING_DHLGKAPI_PL_DESC', 'Delivery to your preferred drop-off location');
define('MODULE_SHIPPING_DHLGKAPI_PL_TOOLTIP', 'Choose a weather-protected and non-visible place on your property, where we can deposit the parcel in your absence.');
define('MODULE_SHIPPING_DHLGKAPI_PL_PLACEHOLDER', 'name, street and  housenumber');
define('MODULE_SHIPPING_DHLGKAPI_PN_TITLE', 'Preferred neighbor');
define('MODULE_SHIPPING_DHLGKAPI_PN_DESC', 'Delivery to a neighbor of your choice');
define('MODULE_SHIPPING_DHLGKAPI_PN_TOOLTIP', 'Determine a person in your immediate neighborhood whom we can hand out your parcel. This person should live in the same building, directly opposite or next door.');
define('MODULE_SHIPPING_DHLGKAPI_PN_PLACEHOLDER', 'e.g. garage, terrace');
define('MODULE_SHIPPING_DHLGKAPI_PT_TITLE', 'Preferred time');
define('MODULE_SHIPPING_DHLGKAPI_PT_DESC', 'Delivery during your preferred time slot');
define('MODULE_SHIPPING_DHLGKAPI_PT_TOOLTIP', 'Indicate a preferred time, which suits you best for your parcel delivery by choosing one of the displayed time windows.');
define('MODULE_SHIPPING_DHLGKAPI_PD_TITLE', 'Preferred day');
define('MODULE_SHIPPING_DHLGKAPI_PD_DESC', 'Delivery at your preferred day');
define('MODULE_SHIPPING_DHLGKAPI_PD_TOOLTIP', 'Choose one of the displayed days as your preferred day for your parcel delivery. Other days are not possible due to delivery processes.');
define('MODULE_SHIPPING_DHLGKAPI_PSF_TITLE', 'Locate a Parcelstation or Post Office');
define('MODULE_SHIPPING_DHLGKAPI_PSF_DESC', 'Or as an alternative choose a shipment to a Parcelstation or a Post Office.');
define('MODULE_SHIPPING_DHLGKAPI_PSF_BUTTON', 'Or as an alternative choose a shipment to a Parcelstation or a Post Office.');
...
define('MODULE_SHIPPING_DHLGKAPI_COD_DHL_FEE_TITLE','Nachnahmegebühr');
