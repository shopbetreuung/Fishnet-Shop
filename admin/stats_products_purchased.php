...
<table class='table table-bordered'>
                  ...
                  ?>
					...
					<td class="dataTableContent" colspan="6" align="right" style="padding-right:20px"><?php echo '<a href="'.$_SERVER['PHP_SELF'].'?clear_all=true&page='.$_GET['page'].'&maxrows='.$maxrows.'"><img src="images/icons/warning.gif" alt="" style="border:0px;" />&nbsp;'.TEXT_RESET_ALL.'&nbsp;<img src="images/icons/warning.gif" alt="" style="border:0px;" /></a>'; ?></td>
				  </tr>	  
                  </table>
                </div>
                ...
                <div class='col-xs-12'>
                    <div class="smallText col-xs-12" ><?php echo TEXT_ROWS. xtc_draw_form('getmaxrows', FILENAME_STATS_PRODUCTS_PURCHASED, 'page='.$_GET['page']) . xtc_draw_input_field('maxrows', $maxrows, 'style="width:50px"'); ?>
                        <input type="image" src="images/icon_arrow_right.gif" alt="los" title="los" /> </form>
                    </div> 
                </div>
