...
*/
  ...
  function showMessageSuccess($message) {
    $message_box = '<div class="col-xs-12 messageStackSuccess"><img border="0" title="" alt="" src="images/icons/success.gif">'.$message.'</div>';
    return $message_box;
  }

  function showMessageError($message) {
    $message = '<div class="col-xs-12 messageStackError"><img border="0" title="" alt="" src="images/icons/error.gif">'.$message.'</div>';
    return $message;
  }
...
<div class="pageHeading col-xs-12 col-sm-6">            
    <p class="h2">
        <?php echo MODULE_PAYMENT_BILLSAFE_2_DETAILS; ?>
    </p>
</div>
...
<br /><?php
  ...
  <?php if ($countOrder['quantity'] == $countUsed['quantity']) { ?>
    <div class='col-xs-12 col-sm-3'><table border="0" cellspacing="0" cellpadding="2"><tr class="dataTableHeadingRow">
