...
class ot_sofort
{
    ...
    function install()
    {
        ...
        xtc_db_query("insert into " . HelperFunctions::escapeSql(TABLE_CONFIGURATION) . " (configuration_key, configuration_value, configuration_group_id, sort_order, date_added) values ('MODULE_ORDER_TOTAL_SOFORT_SORT_ORDER', '48', '6', '2', now())");
