...
/**************************************************************/
	function install() {
		...
		$db_installed = false;
		//BOF - Hetfield - 2010-02-04 - replace mysqli_list_tables with query SHOW TABLES -> PHP5.3 deprecated
		...
		//EOF - Hetfield - 2010-02-04 - replace mysqli_list_tables with query SHOW TABLES -> PHP5.3 deprecated
		if($db_installed==false):
