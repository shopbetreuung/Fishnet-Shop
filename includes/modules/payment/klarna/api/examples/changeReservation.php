...
try {
    $k->changeReservation(
        $rno,
        $amount = 49.99, //New amount (or add to existing amount depending on $flags)
        $flags = KlarnaFlags::NEW_AMOUNT //Amount specified is the new amount, KlarnaFlags::ADD_AMOUNT adds to the existing amount.
    );
