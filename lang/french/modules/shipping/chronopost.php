...
define('MODULE_SHIPPING_CHRONOPOST_INVALID_ZONE', 'Chronopost Pas de livraison disponible pour le pays sélectionné');
...
define('MODULE_SHIPPING_CHRONOPOST_ALLOWED_TITLE' , 'Zones d&apos;expédition');
define('MODULE_SHIPPING_CHRONOPOST_ALLOWED_DESC' , 'Préciser <b>individuel</b> les zones vers lesquelles l&apos;expédition devrait être possible. ex.');
...
define('MODULE_SHIPPING_CHRONOPOST_TAX_CLASS_TITLE' , 'Catégorie fiscale');
define('MODULE_SHIPPING_CHRONOPOST_TAX_CLASS_DESC' , 'Utilisez la classe de taxe suivante sur les frais d&apos;expédition.');
define('MODULE_SHIPPING_CHRONOPOST_ZONE_TITLE' , 'Zone d&apos;expédition');
define('MODULE_SHIPPING_CHRONOPOST_ZONE_DESC' , 'Si une zone est sélectionnée, n&apos;activez cette méthode d&apos;expédition que pour cette zone.');
define('MODULE_SHIPPING_CHRONOPOST_SORT_ORDER_TITLE' , 'Ordre de tri');
define('MODULE_SHIPPING_CHRONOPOST_SORT_ORDER_DESC' , 'séquence de présentation');
