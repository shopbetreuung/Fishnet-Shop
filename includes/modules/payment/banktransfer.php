    ...
    function selection() {
      ...
      $selection = array('id' => $this->code,
                         ...
                         'fields' => array(array('title' => MODULE_PAYMENT_BANKTRANSFER_TEXT_NOTE,
                                           ...
                                           array('title' => MODULE_PAYMENT_BANKTRANSFER_TEXT_BANK_NAME,
                                                 'field' => xtc_draw_input_field('banktransfer_bankname', (isset($_GET['banktransfer_bankname'])) ? utf8_encode($_GET['banktransfer_bankname']) : ((isset($_SESSION['banktransfer_info']['banktransfer_bankname'])) ? utf8_encode($_SESSION['banktransfer_info']['banktransfer_bankname']) : ''), 'size="40" maxlength="64"')),
      ...
      if (MODULE_PAYMENT_BANKTRANSFER_FAX_CONFIRMATION =='true'){
        $selection['fields'][] = array('title' => MODULE_PAYMENT_BANKTRANSFER_TEXT_NOTE,
                                       'field' => MODULE_PAYMENT_BANKTRANSFER_TEXT_NOTE2 . '<a href="' . MODULE_PAYMENT_BANKTRANSFER_URL_NOTE . '" target="_blank" rel="noopener"><b>' . MODULE_PAYMENT_BANKTRANSFER_TEXT_NOTE3 . '</b></a>' . MODULE_PAYMENT_BANKTRANSFER_TEXT_NOTE4);
